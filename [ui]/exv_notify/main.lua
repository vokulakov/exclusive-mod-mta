...
local function addNotification(text, type, _sound)
	...
	if type == 1 then
		color = {0, 255, 0}
		if sound then
			exports["exv_sounds"]:playSound('notify')
		end
	elseif type == 2 then
		color = {255, 0, 0}
		if sound then
			exports["exv_sounds"]:playSound('error')
		end
	end
...
addEvent("exv_notify.addNotification", true)
addEventHandler("exv_notify.addNotification", getRootElement(), addNotification)
...
addEvent("exv_notify.addInformation", true)
addEventHandler("exv_notify.addInformation", getRootElement(), addInformation)
--------------------------------------------------------
