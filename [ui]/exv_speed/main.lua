...
local GEAR_FONT = exports["exv_fonts"]:createFont("AEROMATICS_BOLD.ttf", 12)
local SPEED_FONT = exports["exv_fonts"]:createFont("AEROMATICS_ITALIC.ttf", 30)
local SPEED_UNIT_FONT = exports["exv_fonts"]:createFont("AEROMATICS_ITALIC.ttf", 12)

local FUEL_FONT = exports["exv_fonts"]:createFont("AEROMATICS_ITALIC.ttf", 15)
local FUEL_TEXT_FONT = exports["exv_fonts"]:createFont("AEROMATICS_ITALIC.ttf", 8)
...
local function drawSpeedometr()
	...
	if getElementData(veh, 'exv_vehicle.isCruiseEnable') then
